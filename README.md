...
1. **整包下载** —— [下载 zip](https://github.com/tsinggao0410/Claude-1-Equity-Research/archive/refs/heads/claude/upload-one-pager-public-y6fjxz.zip)，解压后进 `onepagers/<行业目录>/`，双击任意一份。最可靠，完全离线。
